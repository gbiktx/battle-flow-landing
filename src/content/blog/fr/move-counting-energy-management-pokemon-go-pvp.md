...
categories: [Stratégie Avancée, Gestion de l'Énergie]
tags:
  [
    pokemon go,
    pvp,
...
- **Adversaire :** Utilisez Choc Mental (4 tours, 3,5 EPT)
...
- **Adversaire :** Utilisez Riposte (2 tours, 3 EPT)
...
**Wichtig:** "Sous-charge" signifie spécifiquement réduire les dégâts de votre capacité chargée en manquant les bulles du mini-jeu d'attaque. Ce n'est PAS la même chose que lancer avec moins d'énergie (Option 1).
...
Vous gagnerez un avantage massif dans chaque combat. Les joueurs d'élite ne devinent pas—ils **compent les attaques et synchronisent les lancements parfaitement**.
