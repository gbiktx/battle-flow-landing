...
categories: [Estratégia Avançada, Gerenciamento de Energia]
tags:
  [
    pokemon go,
    pvp,
...
Quando ambos os jogadores têm um ataque carregado pronto, o jogador usando o **golpe rápido mais rápido** consegue agir primeiro durante le turno em que ambos atingem seu limite de ataque carregado.
...
- Você quer energia armazenada para le próximo Pokémon
...
- Confusion acabou de terminar e le dano foi registrado
...
**Si seu golpe não se alinha:** Se você alcançar seu limite de ataque carregado no meio de um Confusion (ex: após 7 Counters), espere o Confusion atual dele terminar antes de lançar.

**Nota:** Isso é quase impossível em confrontos espelhados onde ambos os jogadores usam le mesmo golpe rápido—vocês sempre interromperão um ao outro.
...
- Lance quando você alcançar le limite (na conclusão do golpe rápido do oponente)
- Você vencerá le empate CMP e atacará primeiro
- Controle le ritmo da batalha
...
- **Opção 3 (Dano Subcarga):** Intencionalmente erre as bolhas de ataque durante seu ataque carregado (não acerte "Excelente") para reduzir le dano e manter le oponente vivo mais tempo para farm de energia

**Importante:** "Subcarga" especificamente significa reduzir le dano do seu ataque carregado errando as bolhas do minigame de ataque. Isso NÃO é o mesmo que lançar com menos energia (Opção 1).

**Chave:** Mesmo quando ajustando para CMP, sempre lance no turno de conclusão do golpe rápido do oponente - apenas escolha um turno de conclusão DIFERENTE de onde le empate CMP ocorreria.
...
5. **Se você achar que eles VÃO usar shield:** Lance a isca barata (Hydro Cannon) para desperdiçar le shield deles e guardar sua bomba
...
- **Se você achar SIM:** Lance Hydro Cannon (isca barata) para desperdiçar le shield deles
...
**Correção:** Lance no **último turno** do golpe rápido dele (quando le dano se registra) para evitar dar turnos gratuitos.

### Erro 3: Not Construir para Ambos os Golpes

**Jogada Ruim:**
Você lança Hydro Cannon imediatamente aos 9 Mud Shots.
Oponente sabe que é le golpe barato e não usa shield.
Você deve reconstruir de 0 energia.

**Correção:** Construa até **13 Mud Shots** para ter ambos os golpes prontos. Force le oponente a adivinhar e respeitar a ameaça do golpe caro.

## Usando BattleFlow para Dominar le Timing
...
- **Compare Pokémon** lado a lado para escolher le melhor para seu time
...
Dominar le timing de ataque carregado te transforma de um jogador casual em uma ameaça competitiva. Ao entender:
...
1. **Banco de Dados de Golpes do PvPoke** - Dados precisos de golpes incluindo durações de turnos, geração de energia e valores de poder
   Fonte: [PvPoke Moves](https://pvpoke.com/moves/)

2. **Guia do PvPoke para Registro de Golpes Rápidos** - Análise aprofundada de mecánicas de turnos e timing ideal de ataques carregados
